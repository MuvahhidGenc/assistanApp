...
def project_root() -> Path:
    """assistanApp repo root — sabit D: yerine __file__ ile bulunur."""
    if is_frozen():
...
def workspace_root() -> Path:
    """assistanApp'in bulundugu ust klasor (or. calismalarim)."""
    return project_root().parent


def sibling_path(name: str) -> Path:
    """assistanApp ile ayni seviyedeki kardes klasor/dosya yolu."""
