...
class V4Chat:
    def __init__(self, parent: Any, store: Any, on_send_message: Any | None = None) -> None:
        self.store = store
    ...
    def _on_mic(self) -> None:  # pragma: no cover - integration hook
        # Integration hook: voice client start/stop recording.
        # For now: informational only. Do not fabricate voice transcripts.
        pass
