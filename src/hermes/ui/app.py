...
class HermesTrayApplication:
    ...
    def __init__(self, settings: AppSettings, *, config_path: str | None = None, debug: bool = False) -> None:
    ...
    def _on_worker_event(self, event: str, payload: dict[str, Any]) -> None:
        ...
        def _apply() -> None:
            ...
            elif event in ("state", "status", "task_completed", "error", "stopped", "config_reloaded"):
    ...
    def _reload_local_settings(self) -> None:
        ...
        self._config_path = str(path) if path.exists() else self._config_path
