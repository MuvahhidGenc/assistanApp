...
def detect_wake_word(text: str, wake_words: tuple[str, ...] | list[str] | None = None) -> tuple[str | None, str]:
    """
...
def contains_wake_word(text: str, wake_words: tuple[str, ...] | list[str] | None = None) -> bool:
